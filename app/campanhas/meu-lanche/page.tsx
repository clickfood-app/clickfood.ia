      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        ...
        <section className="grid gap-4 md:grid-cols-4">
          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <ChefHat className="mb-4 h-6 w-6 text-violet-600" />
            <p className="text-sm font-medium text-slate-500">Sugestões criadas</p>
            <strong className="mt-2 block text-2xl font-black text-slate-950">0</strong>
          </div>

          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <Flame className="mb-4 h-6 w-6 text-violet-600" />
            <p className="text-sm font-medium text-slate-500">Ofertas ativas</p>
            <strong className="mt-2 block text-2xl font-black text-slate-950">0</strong>
          </div>

          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <ShoppingBasket className="mb-4 h-6 w-6 text-violet-600" />
            <p className="text-sm font-medium text-slate-500">Pedidos gerados</p>
            <strong className="mt-2 block text-2xl font-black text-slate-950">0</strong>
          </div>

          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <Sparkles className="mb-4 h-6 w-6 text-violet-600" />
            <p className="text-sm font-medium text-slate-500">Ideias disponíveis</p>
            <strong className="mt-2 block text-2xl font-black text-slate-950">0</strong>
          </div>
        </section>
