...
export default function EquipePage() {
  ...
  return (
    <AdminLayout>
      <main className="min-h-screen bg-[#111111] px-4 py-4 text-white md:px-6">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-4">
          <section className="flex flex-col gap-3 rounded-2xl border border-white/10 bg-[#0A0A0A] px-4 py-4 shadow-sm md:flex-row md:items-center md:justify-between">
            <div>
            ...
            <section className="rounded-2xl border border-white/10 bg-[#0A0A0A] p-4 shadow-sm">
              ...
              <div className="grid gap-3 md:grid-cols-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="h-10 w-full rounded-xl border border-white/10 bg-[#0A0A0A] px-3 text-sm outline-none focus:border-yellow-400/30 focus:ring-2 focus:ring-yellow-400/20"
                  >
              ...
              <div className="mt-4 flex justify-end gap-2">
                ...
                <Button
                  ...
                  className="h-10 rounded-xl bg-yellow-400 px-5 font-semibold text-black hover:bg-yellow-300"
                >
                  {isSaving ? (
                    <>
          ...
          <section className="rounded-2xl border border-white/10 bg-[#0A0A0A] shadow-sm">
                  ...
                  <tbody>
                    {filteredStaffMembers.map((member) => {
                      ...
                      return (
                        <tr
                          key={member.id}
                          className="border-b border-white/10 transition hover:bg-[#111111]"
                        >
